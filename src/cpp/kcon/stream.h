...
class KConOStream
{
	...
	void _format( const Node<pcell_t,pcell_t>* pcell );
	void _format( const Node<pcell_t,value_t>* pcell );
	void _format( const Node<value_t,pcell_t>* pcell );
	void _format( const Node<value_t,value_t>* pcell );
